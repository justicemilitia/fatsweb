...
export class FixedAssetCardPropertyService {
  ...
  GetFixedAssetCardProperties(success, failed) {
    this.httpClient.get(SERVICE_URL + GET_FIXEDASSETCARDPROPERTY_LIST, {
  ...
  InsertFixedAssetCardProperty(fixedAssetCardProperty: FixedAssetCardProperty, success, failed) {
    this.httpClient
      .post(
        SERVICE_URL + INSERT_FIXEDASSETCARDPROPERTY, fixedAssetCardProperty, {
          headers: GET_HEADERS(this.authenticationService.getToken())
        })
      .subscribe(
        result => {
          ...
          if (response.ResultStatus == true) {
            ...
            Object.assign(insertedFixedAssetCardProperty, response.ResultObject);
  ...
  UpdateFixedAssetCardProperty(fixedAssetCardProperty: FixedAssetCardProperty, success, failed) {
    this.httpClient
      .put(SERVICE_URL + UPDATE_FIXEDASSETCARDPROPERTY, fixedAssetCardProperty, {
        headers: GET_HEADERS(this.authenticationService.getToken())
      })
      .subscribe(
        result => {
  ...
  GetFixedAssetCardPropertyById(fixedAssetCardPropertyId: number, success, failed) {
    this.httpClient
      .get(SERVICE_URL + GET_FIXEDASSETCARDPROPERTY_BY_ID + "/" + fixedAssetCardPropertyId, {
        headers: GET_HEADERS(this.authenticationService.getToken())
      })
      .subscribe(result => {
        let response: Response = <Response>result;
  ...
  DeleteFixedAssetCardProperties(ids: number[], success, failed) {
    this.httpClient.post(SERVICE_URL + DELETE_FIXEDASSETCARDPROPERTY, { "FixedAssetCardPropertyIds": ids }, {
      headers: GET_HEADERS(this.authenticationService.getToken()),
    }).subscribe(
      result => {
        let response: Response = <Response>result;
